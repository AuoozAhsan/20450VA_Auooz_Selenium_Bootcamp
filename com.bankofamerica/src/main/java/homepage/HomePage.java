...
public class HomePage extends BasePage {
    ...
    @FindBy(xpath = "//div[@class='disclosuresitem disclosuresitem--generic text']//table")
    ...
    public int getRowCount() {
        return driver.findElements(By.xpath("//div[@class='disclosuresitem disclosuresitem--generic text']//table")).size();
    }
